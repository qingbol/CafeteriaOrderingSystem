...
public class FoodView extends AppCompatActivity  {
    ...
    class sMessageHandler extends Handler//////////////////////////////网上抄来的实现服务的代码
    {
        @Override
...
// TODO Auto-generated method stub
        if(item.getItemId() == R.id.menu_under_order){
            ...
            Button button_start_updata=(Button)findViewById(item.getItemId());
            //if(item.getTitle()=="启动实时更新"){

               // item.setTitle("停止实时更新");
                try {
                    Message msgFromClient = Message.obtain(null, 1, 0, 0);// h        设置的target值//what设置的what值// arg1 设置的arg1值//arg2 设置的arg2值
