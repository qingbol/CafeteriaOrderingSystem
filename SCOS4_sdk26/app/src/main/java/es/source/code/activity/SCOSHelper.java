                ...
                // 当短信发送完毕后，使用 Toast提示“求助短信发送成功
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mailInfo.setUserName("ustc_lab@126.com");
                            mailInfo.setPassword("asdfasdf123");// 您的邮箱密码
                            mailInfo.setFromAddress("ustc_lab@126.com");
                            mailInfo.setToAddress("ustc_lab@126.com");
